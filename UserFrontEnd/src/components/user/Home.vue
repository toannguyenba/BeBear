    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                <h1 class="h1">Các sản phẩm hot nhất</h1>
                <p>
                    Đây là các sản phẩm được nhiều người dùng săn đón nhất trong tháng qua.
                    Ghé thăm các sản phẩm này nhé!!!
                </p>
            </div>
        </div>
        <div class="row">
    ...
    <section class="bg-light">
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1">Các sản phẩm sale</h1>
                    <p>
                        Đây là các sản phẩm super sale của shop, nhanh tay nào
                    </p>
                </div>
            </div>
            <div class="row">
